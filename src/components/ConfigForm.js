...
const ConfigForm = ({ onSaveConfig, onCancel }) => {
  ...
  return (
    <div className="form-container">
      ...
      <form id="config" onSubmit={handleSubmit}>
        ...
        <input type="text" id="facebook_page_id" name="facebook_page_id" value={config.facebook_page_id} onChange={handleChange} />

        <label htmlFor="headline">Headline:</label>
        <input type="text" id="headline" name="headline" value={config.headline} onChange={handleChange} />

        <label htmlFor="link">Link:</label>
        <input type="text" id="link" name="link" value={config.link} onChange={handleChange} />

        <label htmlFor="utm_parameters">UTM Parameters:</label>
        <input type="text" id="utm_parameters" name="utm_parameters" value={config.utm_parameters} onChange={handleChange} />
